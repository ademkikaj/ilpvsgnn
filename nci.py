...
import sys
from Benchmark.Nci.toGraph import toGraph
from Benchmark.Nci.toLogic import toLogic
...
logic_converter = toLogic(dataset_name=dataset_name,relational_path=relational_path_train)
logic_converter_test = toLogic(dataset_name=dataset_name,relational_path=relational_path_test)
...
for repr in representations:
    ...
    if repr == "node_only":
        ...
        aleph_settings = [
            ":- modeb(*,parent(+puzzle, -node_id, -name)).\n",
            ":- modeb(*,parent(+puzzle, +node_id, -name)).\n",
            ":- modeb(*,parent(+puzzle, -node_id, +name)).\n",
            ":- modeb(*,child(+puzzle, -node_id, -name)).\n",
            ":- modeb(*,child(+puzzle, +node_id, -name)).\n",
            ":- modeb(*,child(+puzzle, -node_id, +name)).\n",
            ":- modeb(*,person(+puzzle, -node_id, -name)).\n",
            ":- modeb(*,person(+puzzle, +node_id, -name)).\n",
            ":- modeb(*,person(+puzzle, -node_id, +name)).\n",
        ...
        tilde_settings = [
            ...
            "warmode(atom(+id,+-node_id,-atom_type)).\n",
            "warmode(bond(+id,+-node_id,+-node_id,-bond_type)).\n",
        ]
        aleph_settings = [
            ":- modeb(*,atom(+puzzle, -node_id, #atom_type)).\n",
            ":- modeb(*,atom(+puzzle, +node_id, #atom_type)).\n",

            ":- modeb(*,bond(+puzzle, -node_id, -node_id, #bond_type)).\n",
            ":- modeb(*,bond(+puzzle, +node_id, -node_id, #bond_type)).\n",
            ":- modeb(*,bond(+puzzle, -node_id, +node_id, #bond_type)).\n",

            f":- determination({dataset_name}/1,atom/3).\n",
            f":- determination({dataset_name}/1,bond/3).\n",
        ]
        ...
        aleph_settings = [
            ":- modeb(*,parent(+puzzle, -node_id, -name,-name)).\n",
            ":- modeb(*,parent(+puzzle, +node_id, -name,-name)).\n",
            ":- modeb(*,parent(+puzzle, -node_id, +name,-name)).\n",
            ":- modeb(*,parent(+puzzle, -node_id, -name,+name)).\n",
            ...
            ":- modeb(*,same_gen(+puzzle, -node_id, -node_id,-name)).\n",
            ":- modeb(*,same_gen(+puzzle, +node_id, -node_id,-name)).\n",
            ":- modeb(*,same_gen(+puzzle, -node_id, +node_id,-name)).\n",
            ":- modeb(*,same_gen(+puzzle, -node_id, -node_id,+name)).\n",
