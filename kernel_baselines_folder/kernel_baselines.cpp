...
#else
    #include </opt/homebrew/Cellar/pybind11/2.12.0/include/pybind11/pybind11.h>
    #include </opt/homebrew/Cellar/pybind11/2.12.0/include/pybind11/stl.h>
    #include </opt/homebrew/Cellar/pybind11/2.12.0/include/pybind11/eigen.h>
#endif
...
GramMatrix compute_wl_1_sparse(GraphDatabase& gdb, int num_iterations, bool use_labels, bool use_edge_labels) {
    //GraphDatabase gdb = AuxiliaryMethods::read_graph_txt_file(ds);
    //gdb.erase(gdb.begin() + 0);
