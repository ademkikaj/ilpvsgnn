...
representations = ["edge_based","node_only","node_edge","Klog"]
target = "intelligence"
...
for repr in representations:
    ...
    if repr == "node_only":
        ...
        aleph_settings = [
            ...
            f":- determination({dataset_name}/1,course/4).\n",
            f":- determination({dataset_name}/1,professor/4).\n",
            f":- determination({dataset_name}/1,registered/5).\n",
            f":- determination({dataset_name}/1,ra/5).\n",
        ]
        ...
        aleph_settings = [
            ...
            ":- modeb(*,ra(+puzzle,-node_id,-prof_id, -sal)).\n",
            f":- determination({dataset_name}/1,students/3).\n",
            f":- determination({dataset_name}/1,course/3).\n",
            f":- determination({dataset_name}/1,professor/3).\n",
            f":- determination({dataset_name}/1,registered/4).\n",
            f":- determination({dataset_name}/1,ra/4).\n",
        ]
    elif repr == "Klog":
